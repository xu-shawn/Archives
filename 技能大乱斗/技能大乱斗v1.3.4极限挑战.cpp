...
#include<conio.h>
using namespace std;
long long q,p,m,ji[10001]={0},dji[10001]={0},hp=1000,dhp=1000,pg=100,dpg=100,pw,dpw,c=1,b=0,a=0,s=0,ss=0,dc=0,db=0,da=0,ds=0,dss=0,u=3,o,r=1,l,www=0,god=0,lv=1,sa=1,d=1,win=0,lose=0,jie,e=0,du=0,GFS,dGFS,tz=1,atk=0;
...
int main()
{
	...
	Sleep(5000);
	system("cls");
	cout<<"v1.3.4极限挑战"<<endl<<"更新说明:"<<endl<<"1.开放了挑战模式"<<endl<<"2.修复了一些已知bug"<<endl;
