/*
Let it go 20.6.2回复
请大家无视前两个v1.2.4，那是我兄弟猴急地发的，存在重大bug
*/
...
#include<conio.h>
using namespace std;
long long q, p, m, ji[10001] = { 0 }, dji[10001] = { 0 }, hp = 1000, dhp = 1000, pg = 100, dpg = 100, pw, dpw, c = 1, b = 0, a = 0, s = 0, ss = 0, dc = 0, db = 0, da = 0, ds = 0, dss = 0, u = 3, o, r = 1, l, www = 0, god = 0, lv = 1, sa = 1, d = 1, win = 0, lose = 0, jie;
...
int main()
{
	...
	Sleep(5000);
	system("cls");
	cout << "v1.2.4传奇再临 " << endl << "更新说明:" << endl << "1.开放技能解印术(3)，无效化(26)，轮回斩(33)" << endl << "2.修复了一些已知bug" << endl;
		...
		rand:l = rand() % u + 1;
			...
			if (dji[l] == 1)
			{
				if (l == 1)//普攻
				{
					...
					dcheater = 0;
					hp -= dpg;
					cout << "敌人打了你一拳造成了" << pg << "点伤害" << endl;
					if (dFeline == 1)
					{
						dhp -= dpg;
						cout << "敌人被铁索勒掉了" << pg << "滴血" << endl;
					}
					system("pause");
					goto AImod;
				}
...
live:system("cls");
	...
	if (win == 8)
	{
		...
		Sleep(1000);
		cout << "祝您游戏愉快，方便的话，在http://noi_openjudge_cn/topic/111677/留个言，" << endl;
		Sleep(1000);
