...
#include<conio.h>
using namespace std;
long long q, p, m, ji[10001] = { 0 }, dji[10001] = { 0 }, hp = 1000, dhp = 1000, pg = 100, dpg = 100, pw, dpw, c = 1, b = 0, a = 0, s = 0, ss = 0, dc = 0, db = 0, da = 0, ds = 0, dss = 0, u = 3, o, r = 1, l, www = 0, god = 0;
long long z3 = 0, z4 = 0, z6 = 0, z10 = 0, z11 = 0, z12 = 0, z13 = 0, z15 = 0, z16 = 0, z17 = 0, z18 = 0, z20 = 0, z21 = 0, z23, z28 = 0, z30 = 0;
long long dz3 = 0, dz4 = 0, dz6 = 0, dz10 = 0, dz11 = 0, dz12 = 0, dz13 = 0, dz15 = 0, dz16 = 0, dz17 = 0, dz18 = 0, dz20 = 0, dz21 = 0, dz23, dz28 = 0, dz30 = 0;
...
int main()
{
	...
	Sleep(5000);
	system("cls");
	cout << "v1.0.0传奇伊始" << endl << "更新说明:" << endl << "1.开放技能至30" << endl << "2.开放人机对战模式" << endl;
	system("pause");
	ji[1] = 1;
	ji[2] = 1;
	dji[1] = 1;
...
play:system("cls");
choose:cout << "1.游玩" << endl << "2.技能" << endl << "3.自动合成技能券" << endl << "4.退出" << endl;
	cin >> q;
	if (q == 1)
	{
	mod:system("cls");
