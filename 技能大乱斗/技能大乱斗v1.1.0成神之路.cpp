...
#include<conio.h>
using namespace std;
long long q, p, m, ji[10001] = { 0 }, dji[10001] = { 0 }, hp = 1000, dhp = 1000, pg = 100, dpg = 100, pw, dpw, c = 1, b = 0, a = 0, s = 0, ss = 0, dc = 0, db = 0, da = 0, ds = 0, dss = 0, u = 3, o, r = 1, l, www = 0, god = 0, lv = 1;
...
int main()
{
	...
	Sleep(5000);
	system("cls");
	cout << "v1.1.0成神之路" << endl << "更新说明:" << endl << "1.开放了段位系统" << endl;
	system("pause");
	ji[1] = 1;
	ji[2] = 1;
	dji[1] = 1;
