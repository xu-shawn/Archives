...
#include<conio.h>
using namespace std;
long long q, p, m, ji[10001] = { 0 }, dji[10001] = { 0 }, hp = 1000, dhp = 1000, pg = 100, dpg = 100, pw, dpw, c = 1, b = 0, a = 0, s = 0, ss = 0, dc = 0, db = 0, da = 0, ds = 0, dss = 0, u = 3, o, r = 1, l, www = 0, god = 0, lv = 1, sa = 1, d = 1;
...
int main()
{
	...
	Sleep(5000);
	system("cls");
	cout << "v1.1.8智慧之光" << endl << "更新说明:" << endl << "1.开放了更完善的存档系统(会存你的技能券和段位，你学过的技能会等价转化为技能券，会在你桌面上生成一个叫技能大乱斗存档.txt的文件，删除会清空存档)2.完善了段位系统，推出了休闲模式(不计段位)3.修复了一些已知bug" << endl;
